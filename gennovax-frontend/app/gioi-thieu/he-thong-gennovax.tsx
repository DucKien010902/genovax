...
import { 
  Users, Network, BarChart, Cpu, 
  MapPin, CheckCircle, Clock, Star,
  ClipboardList, Dna, TestTube, Bug
} from 'lucide-react';
...
const capacityData = {
  image: 'https://res.cloudinary.com/da6f4dmql/image/upload/v1763106517/Screenshot_18_j3gfv5.png',
  title: 'Năng Lực Cốt Lõi',
  description: 'GennovaX xây dựng nền tảng vững chắc từ nhân sự chuyên môn cao đến hệ thống trang thiết bị hiện đại, đảm bảo năng lực xử lý khối lượng mẫu lớn mỗi ngày.',
  stats: [
...
const networkData = {
  image: 'https://res.cloudinary.com/da6f4dmql/image/upload/v1763106512/Screenshot_17_zmtes0.png',
  title: 'Phát Triển & Cam Kết Dịch Vụ',
  description: 'Với mạng lưới 68 điểm thu mẫu toàn quốc và quy trình tối ưu, chúng tôi cam kết mang đến dịch vụ 5 sao: Chuẩn xác - Nhanh - Chuyên nghiệp - Linh hoạt.',
  stats: [
    { icon: MapPin, text: '68 điểm lấy mẫu toàn quốc' },
    { icon: Star, text: 'Cam kết dịch vụ chuẩn 5 sao' },
    { icon: Clock, text: 'Nhận mẫu siêu tốc (Nội thành < 1h, Ngoại thành < 3h)' },
    { icon: CheckCircle, text: 'Trả kết quả nhanh nhất (Khách Key < 6h, Thường < 72h)' },
  ]
};
...
const servicesData = {
  ...
  description: 'Chúng tôi cung cấp một hệ sinh thái xét nghiệm gen toàn diện, đáp ứng mọi nhu cầu sàng lọc và chẩn đoán y học chính xác.',
  stats: [
