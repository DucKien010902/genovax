          ...
          <div className="flex items-center gap-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="hidden sm:block text-left">
                    ...
                    <div className="text-xs text-neutral-600">Admin tools</div>
                  </div>
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 rounded-2xl border border-black/10 bg-white/80 px-3 py-2 shadow-md hover:bg-white/90 backdrop-blur"
              >
              ...
              {openUser && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 z-50 w-56 overflow-hidden rounded-2xl bg-white/90 shadow-xl ring-1 ring-black/10 backdrop-blur">
                    ...
                    <button
                      className="w-full px-4 py-2 text-left text-sm text-rose-600 hover:bg-rose-50/70"
                      onClick={() => {
                        setOpenUser(false);
                        logout();
